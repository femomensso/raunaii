    ...
    <section class="container mx-auto px-2 mb-4">  
        <div class="flex items-center justify-center py-6 px-4">
            <div class="bg-gray-100 max-w-xl space-y-8 w-full px-8 pb-8">
                ...
                <form class="mt-8 space-y-6" action="/admin/categorias/editar/{{$category->id}}" method="POST">
                @csrf                    
                    <div class="">                        
                        <div class="pt-4">
                            <label for="name" class="sr-only">Nome</label>
                            <input id="name" name="name" type="text" autocomplete="name" required value="{{old('name', $category->name)}}"
